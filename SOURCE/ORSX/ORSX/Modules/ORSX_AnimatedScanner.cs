...
namespace ORSX
{
    public class ORSX_AnimatedScanner : PartModule
    {
        [KSPField]
        ...
        private List<ORSX_SurfaceScanner> _scanners;
        ...
        private void FindScanners()
        {
            if (vessel != null)
            {
                if (part.Modules.Contains("ORSX_SurfaceScanner"))
                {
                    _scanners = part.Modules.OfType<ORSX_SurfaceScanner>().ToList();
                }
            }
        }
