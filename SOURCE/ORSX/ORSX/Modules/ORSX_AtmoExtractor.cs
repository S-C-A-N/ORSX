...
namespace ORSX
{
    public class ORSX_AtmoExtractor : PartModule
    {
        [KSPField]
        ...
        private List<ORSX_ModuleAirScoop> _extractors;
        ...
        private void FindExtractors()
        {
            if (vessel != null)
            {
                if (part.Modules.Contains("ORSX_ModuleAirScoop"))
                {
                    _extractors = part.Modules.OfType<ORSX_ModuleAirScoop>().ToList();
                }
            }
        }
