...
namespace ORSX
{
    public class ORSX_PlanetaryResourceInfo
    {
        ...
        public ORSX_PlanetaryResourceInfo(string name, Texture2D map, int body)
        {
            this.name = name;
            this.map = map;
            this.body = body;
        ...
        public double getPixelAbundanceValue(int pix_x, int pix_y)
        {
            ...
            if (getResourceScale() == ORSX_PlanetaryResourceInfo.LOG_SCALE)
            {
                resource_val = Math.Pow(scale_factor, pix_color.grayscale * 255.0) / 1000000 * scale_multiplier;
            }
            else if (getResourceScale() == ORSX_PlanetaryResourceInfo.LINEAR_SCALE)
            {
        ...
        public void setResourceScale(string scalestr)
        {
            ...
            {
                scale = ORSX_PlanetaryResourceInfo.LOG_SCALE;
            }
            else if (scalestr == "LINEAR_SCALE")
            {
                scale = ORSX_PlanetaryResourceInfo.LINEAR_SCALE;
            }
        }
